import { Button, Card, makeStyles, Paper, Radio, TextField, Typography } from '@material-ui/core'
...
const useStyles = makeStyles((theme) => ({
    ...
    root: {
        ...
        "& button:hover": {
            backgroundColor: theme.palette.primary.main, //accedemos desde la variable creada en app.js
            color: "#fff",
        }
    },
    sectioncontent: {
